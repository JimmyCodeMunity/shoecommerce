...
<body>
    <div class="flex flex-row justify-between items-center w-full">
        ...
        <div class="w-full">
            <div class="w-full h-full justify-start py-5 items-start">
                <div class="rounded-2xl overflow-hidden">
                <img src="assets/banner.jpg" alt="" className="rounded-2xl object-cover w-full">
                </div>
    ...
    <!-- display -->
    <div class="w-full flex flex-row justify-between items-center space-x-5 sm:px-16 px-6">
            <div class="w-full grid rounded-xl overflow-hidden relative h-[200px]">
            ...
            <div class="w-full grid rounded-xl overflow-hidden relative h-[200px]">
                <img src="assets/airblack.jpg" class="w-full h-full rounded-xl object-cover" alt="">
                <div class="absolute space-y-2 z-20 bg-black bg-opacity-50 flex flex-col inset w-full h-full justify-center items-center">
                    <p class="text-white text-lg">New orders</p>
                    <p class="text-white text-2xl font-bold">Airforce1 Black</p>
                    <a href="" class="border text-white rounded-2xl px-4 border-white border-2">
                        Shop
                    </a>
                </div>
